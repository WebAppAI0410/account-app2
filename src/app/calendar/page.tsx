  ...
  return (
    <SidebarProvider defaultOpen={false}>
      <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] min-h-screen relative overflow-x-hidden">
        ...
        <main className="w-full max-w-full flex-1 p-2 md:p-0 space-y-4 transition-all duration-300 ease-in-out" style={{transitionProperty: 'width, margin', transform: 'translateZ(0)', willChange: 'width, margin'}} aria-label="カレンダー">
          <PageHeader
            title={t('calendar')}
          ...
          <Card>
            <CardContent className="p-0">
              <div className="calendar-container w-full max-w-full">
                {/* カレンダー本体 */}
                {renderCalendarView()}
              </div>
            </CardContent>
